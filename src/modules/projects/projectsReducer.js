import { FORM_REQUEST, FORM_SUBMITTED, SUBMIT_FAILURE, PROJECT_FETCH_SUCCESS, PROJECT_FETCH_FAILURE, DEL_SUCCESS,
    USERS_DATA_FETCH, USERDATA_FETCH_FAILURE   } from './projectsAction'
...
export const getPropsMap = (state, reducer) => {
    const props = state['projectReducer'];
